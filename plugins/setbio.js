...
const QUOTE_URLS = [
    'https://raw.githubusercontent.com/JuniasWrld/Islamic-Database/main/text/random_quotes.txt',
    'https://raw.githubusercontent.com/JuniasWrld/Islamic-Database/main/text/motivational_quotes.txt',
    'https://raw.githubusercontent.com/JuniasWrld/Islamic-Database/main/text/pickup_quotes.txt'
];
let cachedQuotes = [];
let lastFetchTime = 0;
...
async function fetchQuotes() {
    try {
        ...
        if (allQuotes.length === 0) {
            ...
            return [
                '💎 By Juniaswrld-MD - Your WhatsApp Bot',
        ...
        return cachedQuotes.length > 0 ? cachedQuotes : ['💎 By Juniaswrld-MD - Your WhatsApp Bot'];
    }
}
function getRandomQuote(quotes) {
    if (!quotes || quotes.length === 0)
        return '💎 By Juniaswrld-MD';
