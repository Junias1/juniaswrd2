...
const config = {
    // Bot Identity
    botName: process.env.BOT_NAME || 'Juniaswrld-MD',
    ...
    packname: process.env.PACKNAME || 'Juniaswrld-MD',
    ...
    updateZipUrl: process.env.UPDATE_URL || 'https://github.com/JuniasUshie/Juniaswrld-MD/archive/refs/heads/main.zip',
